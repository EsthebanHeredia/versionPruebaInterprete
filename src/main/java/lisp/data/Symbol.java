...
public class Symbol extends Atom {
    ...
    public static final Symbol DIVIDE = symbol("/");
    ...
    // New predicates
    public static final Symbol LISTP = symbol("LISTP");
    public static final Symbol EQUAL = symbol("EQUAL");
    public static final Symbol LT = symbol("<");
    public static final Symbol GT = symbol(">");
    public static final Symbol EQ_NUM = symbol("="); // Numeric equality
    // Print functions
    public static final Symbol PRINT = symbol("PRINT");
    public static final Symbol PRINC = symbol("PRINC"); // Print without newline
    public static final Symbol PRINT_IF = symbol("PRINT-IF");
    public static final Symbol PRINT_UNLESS = symbol("PRINT-UNLESS");
    // Case statement
    public static final Symbol CASE = symbol("CASE");
    // Parameters symbol
    public static final Symbol PARAMS = symbol("*PARAMS*");
